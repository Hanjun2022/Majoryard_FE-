...
const NewsBoardContents = () => {
        ...
        return (
            <div className="NewsCard-div">
                <div className="NewsCard">
                    ...
                    <div className="NewsCard-content">{content}</div>
                ...
                {image && <img src={image} alt="Card" className="NewsCard-image" />}
            </div>
        );
    };
    ...
    return (
        <div className="newsboard">
            ...
            <div className="newsboard-contents">
...
export default NewsBoardContents;
